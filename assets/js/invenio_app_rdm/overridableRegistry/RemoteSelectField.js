...
export class RemoteSelectField extends Component {
  ...
  // value is new SubjectElementFormValue's
  onSelectValue = (event, { options, value }, callbackFunc) => {
    ...
    console.log("RemoteSelectField::onSelectValue");
    console.log("** options PROBABLY IMPORTANT ONE");
    console.dir(options);
    console.log("**");
    console.log("** value");
    console.dir(value);
    ...
    console.dir(this.state.suggestions);
    console.log("**");

    console.log("** newSelectedSuggestions");
    console.dir(newSelectedSuggestions);
    console.log("**");
  ...
  handleAddition = (e, { value }, callbackFunc) => {
    ...
    const newSelectedSuggestions = [...this.props.value, selectedSuggestion];
  ...
  onBlur = () => {
    this.setState((prevState) => ({
      ...
      error: false,
      searchQuery: null,
      // remove because don't see the need...
  ...
  render() {
    ...
    // Start here
    const value = compProps.convertSelectedToValue(compProps.selected);
    const options = _uniqBy(
      [...compProps.selected, ...suggestions],
      "value"
    );

    console.log("RemoteSelectField::render");
    console.log("** compProps.selected");
    console.dir(compProps.selected);
    console.log("** options");
    console.dir(options);
    console.log("** value");
    console.dir(value);
